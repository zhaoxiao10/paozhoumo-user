# coding: utf-8
class PaozhoumoUser::OmniauthCallbacksController < Devise::OmniauthCallbacksController
      ...
      class_eval %Q{
        def #{provider}
          if not current_user.blank?
            ...
            @user = PaozhoumoUser::User.find_or_create_for_#{provider}(env["omniauth.auth"])
            if @user.persisted?
